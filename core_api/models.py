...
class Entry(models.Model):
    entry_venue_code = models.ForeignKey(Venue, on_delete=models.CASCADE)
    entry_hku_id = models.ForeignKey(HKUMember, on_delete=models.CASCADE)
...
class Exit(models.Model):
    exit_venue_code = models.ForeignKey(Venue, on_delete=models.CASCADE)
    exit_hku_id = models.ForeignKey(HKUMember, on_delete=models.CASCADE)
